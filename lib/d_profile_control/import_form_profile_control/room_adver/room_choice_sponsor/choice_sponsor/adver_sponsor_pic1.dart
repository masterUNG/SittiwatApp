...
class AdverSponsorPic1 extends StatefulWidget {
  const AdverSponsorPic1({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic1State createState() => _AdverSponsorPic1State();
}

class _AdverSponsorPic1State extends State<AdverSponsorPic1> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 3.6 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
