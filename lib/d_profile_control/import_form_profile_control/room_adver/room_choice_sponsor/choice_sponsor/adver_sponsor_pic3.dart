...
class AdverSponsorPic3 extends StatefulWidget {
  const AdverSponsorPic3({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic3State createState() => _AdverSponsorPic3State();
}

class _AdverSponsorPic3State extends State<AdverSponsorPic3> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 3 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
