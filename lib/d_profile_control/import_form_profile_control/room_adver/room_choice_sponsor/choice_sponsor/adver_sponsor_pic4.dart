...
class AdverSponsorPic4 extends StatefulWidget {
  const AdverSponsorPic4({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic4State createState() => _AdverSponsorPic4State();
}

class _AdverSponsorPic4State extends State<AdverSponsorPic4> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 2.7 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadภาพโฆษณาแบบที่4")
            .snapshots(),
