...
class AdverSponsorPic5 extends StatefulWidget {
  const AdverSponsorPic5({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic5State createState() => _AdverSponsorPic5State();
}

class _AdverSponsorPic5State extends State<AdverSponsorPic5> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 2.4 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadภาพโฆษณาแบบที่5")
            .snapshots(),
