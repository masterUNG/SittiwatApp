...
class AdverSponsorPic6 extends StatefulWidget {
  const AdverSponsorPic6({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic6State createState() => _AdverSponsorPic6State();
}

class _AdverSponsorPic6State extends State<AdverSponsorPic6> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 2.1 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
