...
class AdverSponsorPic8 extends StatefulWidget {
  const AdverSponsorPic8({Key? key}) : super(key: key);

  @override
  _AdverSponsorPic8State createState() => _AdverSponsorPic8State();
}

class _AdverSponsorPic8State extends State<AdverSponsorPic8> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 1.5 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadภาพโฆษณาแบบที่8")
            .snapshots(),
