...
class AdverSponsorVdo1 extends StatefulWidget {
  const AdverSponsorVdo1({Key? key}) : super(key: key);

  @override
  _AdverSponsorVdo1State createState() => _AdverSponsorVdo1State();
}

class _AdverSponsorVdo1State extends State<AdverSponsorVdo1> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 6 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadVDOโฆษณาแบบที่1")
            .snapshots(),
