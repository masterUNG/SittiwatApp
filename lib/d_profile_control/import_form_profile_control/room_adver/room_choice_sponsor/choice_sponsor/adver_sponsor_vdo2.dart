...
class AdverSponsorVdo2 extends StatefulWidget {
  const AdverSponsorVdo2({Key? key}) : super(key: key);

  @override
  _AdverSponsorVdo2State createState() => _AdverSponsorVdo2State();
}

class _AdverSponsorVdo2State extends State<AdverSponsorVdo2> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 5 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadVDOโฆษณาแบบที่2")
            .snapshots(),
