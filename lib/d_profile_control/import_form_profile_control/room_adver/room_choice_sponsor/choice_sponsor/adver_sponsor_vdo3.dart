...
class AdverSponsorVdo3 extends StatefulWidget {
  const AdverSponsorVdo3({Key? key}) : super(key: key);

  @override
  _AdverSponsorVdo3State createState() => _AdverSponsorVdo3State();
}

class _AdverSponsorVdo3State extends State<AdverSponsorVdo3> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 4 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("uploadVDOโฆษณาแบบที่3")
            .snapshots(),
