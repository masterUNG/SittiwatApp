...
class AdverSponsorVdo4 extends StatefulWidget {
  const AdverSponsorVdo4({Key? key}) : super(key: key);

  @override
  _AdverSponsorVdo4State createState() => _AdverSponsorVdo4State();
}

class _AdverSponsorVdo4State extends State<AdverSponsorVdo4> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: MyStyle().fonWhite15("คุณมีรายได้ประมาณ 9 บาท/การกด1ครั้ง"),
      ),
      body: StreamBuilder(
