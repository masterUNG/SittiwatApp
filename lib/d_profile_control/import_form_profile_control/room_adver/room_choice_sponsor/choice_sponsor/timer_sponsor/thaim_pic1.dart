...
class ThaimPic1 extends StatefulWidget {
  const ThaimPic1({Key? key}) : super(key: key);

  @override
  _ThaimPic1State createState() => _ThaimPic1State();
}

class _ThaimPic1State extends State<ThaimPic1> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic1");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 1"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
