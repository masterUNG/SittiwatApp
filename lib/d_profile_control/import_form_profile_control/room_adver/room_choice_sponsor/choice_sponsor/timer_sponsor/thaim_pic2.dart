...
class ThaimPic2 extends StatefulWidget {
  const ThaimPic2({Key? key}) : super(key: key);

  @override
  _ThaimPic2State createState() => _ThaimPic2State();
}

class _ThaimPic2State extends State<ThaimPic2> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic2");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 2"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
