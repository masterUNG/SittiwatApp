...
class ThaimPic3 extends StatefulWidget {
  const ThaimPic3({Key? key}) : super(key: key);

  @override
  _ThaimPic3State createState() => _ThaimPic3State();
}

class _ThaimPic3State extends State<ThaimPic3> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic3");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 3"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
