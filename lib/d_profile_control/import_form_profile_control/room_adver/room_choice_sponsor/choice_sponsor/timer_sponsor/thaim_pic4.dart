...
class ThaimPic4 extends StatefulWidget {
  const ThaimPic4({Key? key}) : super(key: key);

  @override
  _ThaimPic4State createState() => _ThaimPic4State();
}

class _ThaimPic4State extends State<ThaimPic4> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic4");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 4"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
