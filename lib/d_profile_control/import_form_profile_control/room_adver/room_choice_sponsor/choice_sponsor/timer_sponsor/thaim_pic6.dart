...
class ThaimPic6 extends StatefulWidget {
  const ThaimPic6({Key? key}) : super(key: key);

  @override
  _ThaimPic6State createState() => _ThaimPic6State();
}

class _ThaimPic6State extends State<ThaimPic6> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic6");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 6"))),
        ),
        Container(
          height: 30,
          width: screen * 0.4,
