...
class ThaimPic7 extends StatefulWidget {
  const ThaimPic7({Key? key}) : super(key: key);

  @override
  _ThaimPic7State createState() => _ThaimPic7State();
}

class _ThaimPic7State extends State<ThaimPic7> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic7");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 7"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
