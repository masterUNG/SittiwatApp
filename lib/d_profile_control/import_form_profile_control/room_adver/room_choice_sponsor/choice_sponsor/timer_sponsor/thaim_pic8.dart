...
class ThaimPic8 extends StatefulWidget {
  const ThaimPic8({Key? key}) : super(key: key);

  @override
  _ThaimPic8State createState() => _ThaimPic8State();
}

class _ThaimPic8State extends State<ThaimPic8> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorPic8");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณาภาพชุดที่ 8"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
