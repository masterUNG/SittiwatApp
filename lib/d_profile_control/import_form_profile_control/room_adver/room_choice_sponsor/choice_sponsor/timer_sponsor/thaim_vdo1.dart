...
class ThaimVdo1 extends StatefulWidget {
  const ThaimVdo1({Key? key}) : super(key: key);

  @override
  _ThaimVdo1State createState() => _ThaimVdo1State();
}

class _ThaimVdo1State extends State<ThaimVdo1> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorVdo1");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณา VDO ชุดที่ 1"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
