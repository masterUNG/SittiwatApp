...
class ThaimVdo2 extends StatefulWidget {
  const ThaimVdo2({Key? key}) : super(key: key);

  @override
  _ThaimVdo2State createState() => _ThaimVdo2State();
}

class _ThaimVdo2State extends State<ThaimVdo2> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorVdo2");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณา VDO ชุดที่ 2"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
