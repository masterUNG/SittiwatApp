...
class ThaimVdo4 extends StatefulWidget {
  const ThaimVdo4({Key? key}) : super(key: key);

  @override
  _ThaimVdo4State createState() => _ThaimVdo4State();
}

class _ThaimVdo4State extends State<ThaimVdo4> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorVdo4");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณา VDO ชุดที่ 4"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
