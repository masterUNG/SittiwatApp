...
class ThaimVdo5 extends StatefulWidget {
  const ThaimVdo5({Key? key}) : super(key: key);

  @override
  _ThaimVdo5State createState() => _ThaimVdo5State();
}

class _ThaimVdo5State extends State<ThaimVdo5> {
  late double screen;
  @override
      ...
      children: [
        Container(
          ...
          child: TextButton.icon(
              onPressed: () {
                setState(() {
                  if (stopwatch.isRunning) {
                    ...
                    Navigator.pushNamed(context, "/AdverSponsorVdo5");
                  }
                } 
                );
              },
              ...
              label: Center(child: MyStyle().fonText13("โฆษณา VDO ชุดที่ 5"))),
        ),
        Container(
          height: 35,
          width: screen * 0.4,
