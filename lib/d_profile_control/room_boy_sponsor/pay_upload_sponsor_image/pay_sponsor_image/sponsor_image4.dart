...
class SponsorTwo4 extends StatefulWidget {
  const SponsorTwo4({Key? key}) : super(key: key);

  @override
  _SponsorTwo4State createState() => _SponsorTwo4State();
}

class _SponsorTwo4State extends State<SponsorTwo4> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            MyStyle().fonWhite15("แบบที่ 4."),
            MyStyle().fonWhite12(
                "โฆษณาขึ้นป๊อบอัพแสดงรูปภาพ ความยาว 10 วินาที เริ่มแสดงหลังจากสตอรี่เดินได้ 10วินาทีแรก (ขึ้นอันลำดับที่ 4)"),
            Card(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 1,800 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () async {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadImage4");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาชนิดภาพแบบที่4/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาชนิดภาพแบบที่4")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
