...
class SponsorTwo6 extends StatefulWidget {
  const SponsorTwo6({Key? key}) : super(key: key);

  @override
  _SponsorTwo6State createState() => _SponsorTwo6State();
}

class _SponsorTwo6State extends State<SponsorTwo6> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            MyStyle().fonWhite15("แบบที่ 6."),
            MyStyle().fonWhite12(
                "โฆษณาขึ้นป๊อบอัพแสดงรูปภาพ ความยาว 10 วินาที เริ่มแสดงหลังจากสตอรี่เดินได้ 10วินาทีแรก (ขึ้นอันลำดับที่ 6)"),
            Card(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 1,400 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () async {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadImage6");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาชนิดภาพแบบที่6/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาชนิดภาพแบบที่6")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
