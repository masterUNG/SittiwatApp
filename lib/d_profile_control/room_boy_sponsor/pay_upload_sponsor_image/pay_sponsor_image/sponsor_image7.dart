...
class SponsorTwo7 extends StatefulWidget {
  const SponsorTwo7({Key? key}) : super(key: key);

  @override
  _SponsorTwo7State createState() => _SponsorTwo7State();
}

class _SponsorTwo7State extends State<SponsorTwo7> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            MyStyle().fonWhite15("แบบที่ 7."),
            MyStyle().fonWhite12(
                "โฆษณาขึ้นป๊อบอัพแสดงรูปภาพ ความยาว 10 วินาที เริ่มแสดงหลังจากสตอรี่เดินได้ 10วินาทีแรก (ขึ้นอันลำดับที่ 7)"),
            Card(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 1,200 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () async {
                  if (image == null) {
                   ...
                   Navigator.pushNamed(context, "/UploadImage7");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาชนิดภาพแบบที่7/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาชนิดภาพแบบที่7")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
