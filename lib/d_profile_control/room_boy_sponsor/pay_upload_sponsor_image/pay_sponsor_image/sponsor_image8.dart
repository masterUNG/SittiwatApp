...
class SponsorTwo8 extends StatefulWidget {
  const SponsorTwo8({Key? key}) : super(key: key);

  @override
  _SponsorTwo8State createState() => _SponsorTwo8State();
}

class _SponsorTwo8State extends State<SponsorTwo8> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            MyStyle().fonWhite15("แบบที่ 8."),
            MyStyle().fonWhite12(
                "โฆษณาขึ้นป๊อบอัพแสดงรูปภาพ ความยาว 10 วินาที เริ่มแสดงหลังจากสตอรี่เดินได้ 10วินาทีแรก (ขึ้นอันลำดับที่ 8)"),
            Card(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 1,000 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () async {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadImage8");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาชนิดภาพแบบที่8/product$i.jpg");
