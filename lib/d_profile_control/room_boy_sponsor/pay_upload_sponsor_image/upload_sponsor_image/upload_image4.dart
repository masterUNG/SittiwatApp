...
class UploadImage4 extends StatefulWidget {
  const UploadImage4({Key? key}) : super(key: key);

  @override
  _UploadImage4State createState() => _UploadImage4State();
}

class _UploadImage4State extends State<UploadImage4> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadภาพโฆษณาแบบที่4/product$i.jpg");
