...
class UploadImage5 extends StatefulWidget {
  const UploadImage5({Key? key}) : super(key: key);

  @override
  _UploadImage5State createState() => _UploadImage5State();
}

class _UploadImage5State extends State<UploadImage5> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadภาพโฆษณาแบบที่5/product$i.jpg");
