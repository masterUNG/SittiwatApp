...
class UploadImage7 extends StatefulWidget {
  const UploadImage7({Key? key}) : super(key: key);

  @override
  _UploadImage7State createState() => _UploadImage7State();
}

class _UploadImage7State extends State<UploadImage7> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadภาพโฆษณาแบบที่7/product$i.jpg");
