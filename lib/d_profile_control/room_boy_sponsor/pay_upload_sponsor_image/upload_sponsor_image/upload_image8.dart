...
class UploadImage8 extends StatefulWidget {
  const UploadImage8({Key? key}) : super(key: key);

  @override
  _UploadImage8State createState() => _UploadImage8State();
}

class _UploadImage8State extends State<UploadImage8> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadภาพโฆษณาแบบที่8/product$i.jpg");
