...
class SponsorOne1 extends StatefulWidget {
  const SponsorOne1({Key? key}) : super(key: key);

  @override
  _SponsorOne1State createState() => _SponsorOne1State();
}

class _SponsorOne1State extends State<SponsorOne1> {
  late double screen;
  @override
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            MyStyle().fonWhite12("โฆษณาขึ้นต้นคลิป vdo ความยาว 7 วินาที"),
            Card(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 3,000 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadVdo1");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาVDOแบบที่1/product$i.jpg");
