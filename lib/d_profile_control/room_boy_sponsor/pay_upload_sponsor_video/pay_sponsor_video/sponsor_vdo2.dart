...
class SponsorOne2 extends StatefulWidget {
  const SponsorOne2({Key? key}) : super(key: key);

  @override
  _SponsorOne2State createState() => _SponsorOne2State();
}

class _SponsorOne2State extends State<SponsorOne2> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            MyStyle().fonWhite15("แบบที่ 2."),
            MyStyle().fonWhite12("โฆษณาขึ้นกลางคลิป vdo ความยาว 7 วินาที"),
            Card(
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        MyStyle().fonWhite15(
                            "1).เนื้อหาต้องเป็น Vdo ความยาวไม่เกิน 7 วินาที"),
                        MyStyle().fonWhite15("-ลิ้งโฆษณาจะออก 100 รอบ "),
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 2,500 บาท"),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadVdo2");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาVDOแบบที่2/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาVDOแบบที่2")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
