...
class SponsorOne3 extends StatefulWidget {
  const SponsorOne3({Key? key}) : super(key: key);

  @override
  _SponsorOne3State createState() => _SponsorOne3State();
}

class _SponsorOne3State extends State<SponsorOne3> {
  late double screen;
  @override
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            MyStyle().fonWhite12("โฆษณาขึ้นท้ายก่อนคลิปจบ vdo ความยาว 7 วินาที"),
            Card(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadVdo3");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาVDOแบบที่3/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาVDOแบบที่3")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
