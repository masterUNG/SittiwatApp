...
class SponsorOne4 extends StatefulWidget {
  const SponsorOne4({Key? key}) : super(key: key);

  @override
  _SponsorOne4State createState() => _SponsorOne4State();
}

class _SponsorOne4State extends State<SponsorOne4> {
  late double screen;
  @override
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            MyStyle().fonWhite12("โฆษณาขึ้นด้านล่างคลิป vdo ความยาว 30 วินาที"),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyStyle().fonWhite15("-ราคาโปรโมชั่นพิเศษ 4,500 บาท"),
                        MyStyle().fonWhite15("-ลิ้งโฆษณาจะออก ช่วงต้นคลิป "),
                        MyStyle().fonWhite15(
            ...
            ElevatedButton.icon(
                ...
                onPressed: () {
                  if (image == null) {
                    ...
                    Navigator.pushNamed(context, "/UploadVdo4");
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("จ่ายค่าโฆษณาVDOแบบที่4/product$i.jpg");
  ...
  Future<void> insertValueToFireStore() async {
    ...
    await FirebaseFirestore.instance
        .collection("จ่ายค่าโฆษณาVDOแบบที่4")
        .doc()
        .set(map)
        .then((value) {
      // print("ok Firebase");
