...
class UploadVdo1 extends StatefulWidget {
  const UploadVdo1({ Key? key }) : super(key: key);

  @override
  _UploadVdo1State createState() => _UploadVdo1State();
}

class _UploadVdo1State extends State<UploadVdo1> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadVDOโฆษณาแบบที่1/product$i.jpg");
