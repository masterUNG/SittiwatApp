...
class UploadVdo2 extends StatefulWidget {
  const UploadVdo2({ Key? key }) : super(key: key);

  @override
  _UploadVdo2State createState() => _UploadVdo2State();
}

class _UploadVdo2State extends State<UploadVdo2> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadVDOโฆษณาแบบที่2/product$i.jpg");
