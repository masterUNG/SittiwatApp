...
class UploadVdo3 extends StatefulWidget {
  const UploadVdo3({ Key? key }) : super(key: key);

  @override
  _UploadVdo3State createState() => _UploadVdo3State();
}

class _UploadVdo3State extends State<UploadVdo3> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadVDOโฆษณาแบบที่3/product$i.jpg");
