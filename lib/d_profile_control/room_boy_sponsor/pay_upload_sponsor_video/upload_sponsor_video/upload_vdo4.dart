...
class UploadVdo4 extends StatefulWidget {
  const UploadVdo4({ Key? key }) : super(key: key);

  @override
  _UploadVdo4State createState() => _UploadVdo4State();
}

class _UploadVdo4State extends State<UploadVdo4> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadVDOโฆษณาแบบที่4/product$i.jpg");
  ...
  Future getImagefromVideo() async {
    ...
    final pickedImage = await picker.getVideo(source: ImageSource.camera); //gallery
    setState(() {
