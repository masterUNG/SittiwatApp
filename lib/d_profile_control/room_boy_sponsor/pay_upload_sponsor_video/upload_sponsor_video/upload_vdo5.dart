...
class UploadVdo5 extends StatefulWidget {
  const UploadVdo5({ Key? key }) : super(key: key);

  @override
  _UploadVdo5State createState() => _UploadVdo5State();
}

class _UploadVdo5State extends State<UploadVdo5> {
  late double screen;
  @override
  ...
  Future<void> uploadPictureToStorage() async {
    ...
    Reference storageReference =
        firebaseStorage.ref().child("uploadVDOโฆษณาแบบที่5/product$i.jpg");
