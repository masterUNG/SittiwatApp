...
class SponsorPicg1 extends StatefulWidget {
  const SponsorPicg1({Key? key}) : super(key: key);

  @override
  _SponsorPicg1State createState() => _SponsorPicg1State();
}

class _SponsorPicg1State extends State<SponsorPicg1> {
  late double screen;
  @override
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        MyStyle().fonWhite15("โปรโมชั่น  2,400 บาท แบบที่ 1"),
                        Card(
                          elevation: 1,
                          ...
                          child: ExpansionTile(
                            title: MyStyle().fonWhite15(
                                "รายการโอนเงินค่าโฆษณา ชนิดภาพออก 200 ครั้ง:"),
                            children: [
                              Card(
