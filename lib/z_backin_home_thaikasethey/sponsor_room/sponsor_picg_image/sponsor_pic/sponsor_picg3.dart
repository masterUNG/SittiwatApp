...
class SponsorPicg3 extends StatefulWidget {
  const SponsorPicg3({Key? key}) : super(key: key);

  @override
  _SponsorPicg3State createState() => _SponsorPicg3State();
}

class _SponsorPicg3State extends State<SponsorPicg3> {
  @override
