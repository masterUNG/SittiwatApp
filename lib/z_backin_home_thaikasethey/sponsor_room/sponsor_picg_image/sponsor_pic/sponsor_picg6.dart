...
class SponsorPicg6 extends StatefulWidget {
  const SponsorPicg6({Key? key}) : super(key: key);

  @override
  _SponsorPicg6State createState() => _SponsorPicg6State();
}

class _SponsorPicg6State extends State<SponsorPicg6> {
  @override
