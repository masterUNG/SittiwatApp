...
class SponsorPicg7 extends StatefulWidget {
  const SponsorPicg7({Key? key}) : super(key: key);

  @override
  _SponsorPicg7State createState() => _SponsorPicg7State();
}

class _SponsorPicg7State extends State<SponsorPicg7> {
  @override
