...
class FileUploadImage1 extends StatefulWidget {
  const FileUploadImage1({Key? key}) : super(key: key);

  @override
  _FileUploadImage1State createState() => _FileUploadImage1State();
}

class _FileUploadImage1State extends State<FileUploadImage1> {
  late double screen;
  @override
