...
class FileUploadImage2 extends StatefulWidget {
  const FileUploadImage2({Key? key}) : super(key: key);

  @override
  _FileUploadImage2State createState() => _FileUploadImage2State();
}

class _FileUploadImage2State extends State<FileUploadImage2> {
  late double screen;
  @override
