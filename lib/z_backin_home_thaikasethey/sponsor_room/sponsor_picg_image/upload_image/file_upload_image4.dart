...
class FileUploadImage4 extends StatefulWidget {
  const FileUploadImage4({Key? key}) : super(key: key);

  @override
  _FileUploadImage4State createState() => _FileUploadImage4State();
}

class _FileUploadImage4State extends State<FileUploadImage4> {
  late double screen;
  @override
