...
class FileUploadImage5 extends StatefulWidget {
  const FileUploadImage5({Key? key}) : super(key: key);

  @override
  _FileUploadImage5State createState() => _FileUploadImage5State();
}

class _FileUploadImage5State extends State<FileUploadImage5> {
  late double screen;
  @override
