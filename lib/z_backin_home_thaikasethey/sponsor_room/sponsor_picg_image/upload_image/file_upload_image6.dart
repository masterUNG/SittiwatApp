...
class FileUploadImage6 extends StatefulWidget {
  const FileUploadImage6({Key? key}) : super(key: key);

  @override
  _FileUploadImage6State createState() => _FileUploadImage6State();
}

class _FileUploadImage6State extends State<FileUploadImage6> {
  late double screen;
  @override
