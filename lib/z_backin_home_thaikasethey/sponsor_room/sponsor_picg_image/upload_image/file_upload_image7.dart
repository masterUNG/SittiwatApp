...
class FileUploadImage7 extends StatefulWidget {
  const FileUploadImage7({Key? key}) : super(key: key);

  @override
  _FileUploadImage7State createState() => _FileUploadImage7State();
}

class _FileUploadImage7State extends State<FileUploadImage7> {
  late double screen;
  @override
