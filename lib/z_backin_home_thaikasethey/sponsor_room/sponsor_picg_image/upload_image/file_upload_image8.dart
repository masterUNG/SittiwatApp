...
class FileUploadImage8 extends StatefulWidget {
  const FileUploadImage8({Key? key}) : super(key: key);

  @override
  _FileUploadImage8State createState() => _FileUploadImage8State();
}

class _FileUploadImage8State extends State<FileUploadImage8> {
  late double screen;
  @override
