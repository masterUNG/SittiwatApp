...
class SponsorVdo2 extends StatefulWidget {
  const SponsorVdo2({Key? key}) : super(key: key);

  @override
  _SponsorVdo2State createState() => _SponsorVdo2State();
}

class _SponsorVdo2State extends State<SponsorVdo2> {
  late double screen;
  @override
