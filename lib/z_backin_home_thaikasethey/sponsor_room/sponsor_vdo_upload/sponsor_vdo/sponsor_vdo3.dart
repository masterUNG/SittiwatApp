...
class SponsorVdo3 extends StatefulWidget {
  const SponsorVdo3({Key? key}) : super(key: key);

  @override
  _SponsorVdo3State createState() => _SponsorVdo3State();
}

class _SponsorVdo3State extends State<SponsorVdo3> {
  late double screen;
  @override
