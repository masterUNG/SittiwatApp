...
class SponsorVdo4 extends StatefulWidget {
  const SponsorVdo4({Key? key}) : super(key: key);

  @override
  _SponsorVdo4State createState() => _SponsorVdo4State();
}

class _SponsorVdo4State extends State<SponsorVdo4> {
  late double screen;
  @override
