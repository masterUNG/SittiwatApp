...
class SponsorVdo5 extends StatefulWidget {
  const SponsorVdo5({Key? key}) : super(key: key);

  @override
  _SponsorVdo5State createState() => _SponsorVdo5State();
}

class _SponsorVdo5State extends State<SponsorVdo5> {
  late double screen;
  @override
