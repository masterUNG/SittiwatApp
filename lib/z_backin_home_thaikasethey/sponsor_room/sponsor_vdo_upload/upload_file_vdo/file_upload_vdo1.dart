...
class FileUploadVdo1 extends StatefulWidget {
  const FileUploadVdo1({Key? key}) : super(key: key);

  @override
  _FileUploadVdo1State createState() => _FileUploadVdo1State();
}

class _FileUploadVdo1State extends State<FileUploadVdo1> {
  late double screen;
  @override
