...
class FileUploadVdo2 extends StatefulWidget {
  const FileUploadVdo2({Key? key}) : super(key: key);

  @override
  _FileUploadVdo2State createState() => _FileUploadVdo2State();
}

class _FileUploadVdo2State extends State<FileUploadVdo2> {
  late double screen;
  @override
