...
class FileUploadVdo3 extends StatefulWidget {
  const FileUploadVdo3({Key? key}) : super(key: key);

  @override
  _FileUploadVdo3State createState() => _FileUploadVdo3State();
}

class _FileUploadVdo3State extends State<FileUploadVdo3> {
  late double screen;
  @override
