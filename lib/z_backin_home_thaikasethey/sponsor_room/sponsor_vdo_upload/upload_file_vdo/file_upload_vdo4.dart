...
class FileUploadVdo4 extends StatefulWidget {
  const FileUploadVdo4({Key? key}) : super(key: key);

  @override
  _FileUploadVdo4State createState() => _FileUploadVdo4State();
}

class _FileUploadVdo4State extends State<FileUploadVdo4> {
  late double screen;
  @override
