...
class FileUploadVdo5 extends StatefulWidget {
  const FileUploadVdo5({Key? key}) : super(key: key);

  @override
  _FileUploadVdo5State createState() => _FileUploadVdo5State();
}

class _FileUploadVdo5State extends State<FileUploadVdo5> {
  late double screen;
  @override
