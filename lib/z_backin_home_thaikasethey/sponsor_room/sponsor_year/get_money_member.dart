...
class GetMoneyMember extends StatefulWidget {
  const GetMoneyMember({Key? key}) : super(key: key);

  @override
  _GetMoneyMemberState createState() => _GetMoneyMemberState();
}

class _GetMoneyMemberState extends State<GetMoneyMember> {
  late double screen;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection("จ่ายค่าโฆษณาVDOแบบรายปี").snapshots(),
